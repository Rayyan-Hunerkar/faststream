...
from server.models.users import User, UserAuth, UserOut
# from server.utils.mail import send_password_reset_email
...
async def user_registration(user_auth: UserAuth):
    ...
    password = str(user_auth.password).encode('utf-8')
